...
//robot.motor_up2.power=0.33
    ...
    robot.motor_up1.power = 0.73
    robot.motor_up2.power = -0.73
    ...
    robot.motor_up2.power = -0.015
    robot.move(250, 0.0, 0.4, 0.0)
    robot.move(510, 0.0, 0.0, -0.4)





    robot.motor_up1.power = 0.15
    robot.motor_up2.power = -0.15
    ...
    robot.motor_up1.power = 0.75
    robot.motor_up2.power = -0.75
    robot.move(450, 0.0, 0.4, 0.0)
